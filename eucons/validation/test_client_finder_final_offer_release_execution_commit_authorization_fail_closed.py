...
ENGINE_PATH = ROOT / "eucons" / "leads" / "client_finder_final_offer_release_execution_commit_authorization.py"
CONTRACT_PATH = ROOT / "eucons" / "leads" / "client_finder_final_offer_release_execution_commit_authorization_contract.json"
SOURCE_CONTRACT_PATH = ROOT / "eucons" / "leads" / "client_finder_final_offer_release_execution_review_contract.json"

spec = importlib.util.spec_from_file_location("release_execution_commit_authorization", ENGINE_PATH)
...
def valid_source_review():
    result = {
        ...
        "final_offer_release_execution_review_id": "OFFRELEXECREVIEW-0123456789abcdef01234567",
        "record_state": "CLIENT_FINDER_FINAL_OFFER_RELEASE_EXECUTION_REVIEW_ENVELOPE",
        "source_execution_preparation_contract_id": "EUCONS-R07-CLIENT-FINDER-FINAL-OFFER-RELEASE-EXECUTION-GATE-001",
        ...
        "source_as_of": "2026-08-28T05:30:00Z",
        "execution_review_outcome": "APPROVED_INTERNAL_ONLY",
        "execution_review_state": "INTERNAL_FINAL_OFFER_RELEASE_EXECUTION_ENVELOPE_APPROVED_INTERNAL_ONLY",
        "internal_execution_envelope_review_approved": True,
        "next_gate_hint": "SEPARATE_FINAL_OFFER_RELEASE_EXECUTION_COMMIT_AUTHORIZATION_GATE_REQUIRED",
        "release_execution_commit_authorization_gate_required": True,
        ...
        "decision_receipt": {
            ...
            "decided_at": "2026-08-28T05:45:00Z"
        },
...
def valid_decision():
    ...
    return {
        "source_final_offer_release_execution_review_id": source["final_offer_release_execution_review_id"],
        "source_final_offer_release_execution_preparation_id": source["source_final_offer_release_execution_preparation_id"],
        "source_final_offer_release_execution_authorization_id": source["source_final_offer_release_execution_authorization_id"],
        "source_final_offer_release_package_review_id": source["source_final_offer_release_package_review_id"],
        ...
        "decision_source": "HUMAN",
        "reviewer_ref": "commit-reviewer-ref-001",
        "decided_at": "2026-08-28T06:15:00Z"
    }


def expect_rejected(source=None, decision=None, use_contract=None, use_source_contract=None):
    try:
        module.build_final_offer_release_execution_commit_authorization(
        ...
        return
    raise AssertionError("unsafe release-execution commit authorization input was accepted")


result = module.build_final_offer_release_execution_commit_authorization(
    valid_source_review(), valid_decision(), contract, source_contract
)
assert result["release_execution_commit_authorization_state"] == "FINAL_OFFER_RELEASE_EXECUTION_COMMIT_PREPARATION_AUTHORIZED_INTERNAL_ONLY"
assert result["authorization_scope"] == "NEXT_GATE_ONLY"
assert result["next_gate_hint"] == "SEPARATE_FINAL_OFFER_RELEASE_EXECUTION_COMMIT_PREPARATION_GATE_REQUIRED"
...
assert result == module.build_final_offer_release_execution_commit_authorization(
    valid_source_review(), valid_decision(), contract, source_contract
)

negative = valid_decision()
negative["release_execution_commit_authorization_outcome"] = "RELEASE_EXECUTION_COMMIT_NOT_AUTHORIZED"
negative_result = module.build_final_offer_release_execution_commit_authorization(
...
for field, value in (
    ("execution_review_outcome", "CHANGES_REQUIRED"),
    ("execution_review_state", "INTERNAL_FINAL_OFFER_RELEASE_EXECUTION_ENVELOPE_CHANGES_REQUIRED"),
    ("next_gate_hint", None),
    ("internal_execution_envelope_review_approved", False),
    ("release_execution_commit_authorization_gate_required", False),
...
bad = valid_source_review()
bad["source_as_of"] = "2026-08-28T08:30:00+03:00"
expect_rejected(source=bad)
...
bad = valid_source_review()
bad["decision_receipt"]["decided_at"] = "2026-08-28T08:45:00+03:00"
expect_rejected(source=bad)
...
for field, value in (
    ("source_final_offer_release_execution_review_id", "different-review"),
    ("source_final_offer_release_execution_preparation_id", "different-preparation"),
    ("source_final_offer_release_execution_authorization_id", "different-lineage"),
    ...
    ("source_as_of", "2026-08-28T05:31:00Z"),
    ("release_execution_commit_authorization_outcome", "EXECUTE_NOW"),
...
bad = valid_decision()
bad["decided_at"] = "2026-08-28T09:15:00+03:00"
expect_rejected(decision=bad)
...
print("PASS: Client Finder final-offer release execution commit authorization remains human-only, next-gate-only and fail-closed")
