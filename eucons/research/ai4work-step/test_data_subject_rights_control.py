...
class DataSubjectRightsControlTests(unittest.TestCase):
    ...
    def test_current_policy_accepted_state_is_structurally_safe_and_fail_closed(self):
        ...
        self.assertEqual(self.procedure["request_channel"]["status"], "CONTACT_BOUND_REQUESTER_AUTHENTICATION_PENDING")
    ...
    def test_activation_claim_cannot_bypass_missing_live_rights_operations(self):
        ...
        self.assertNotIn("rights_privacy_contact_missing", errors)
