...
class ProfileCoverageControlTests(unittest.TestCase):
    ...
    def test_canonical_needs_synthesis_wrapper_requires_profile_coverage_precollection_method_and_analysis_plan_locks_and_integrity(self):
        ...
        self.assertEqual(result["schema_version"], "eucons.ai4work_needs_synthesis_gate.v0.5")
        self.assertEqual(result["method_frame_lock_control_schema_version"], "eucons.ai4work_method_frame_lock_control.v0.1")
        self.assertEqual(result["need_analysis_plan_control_schema_version"], "eucons.ai4work_need_analysis_plan_control.v0.2")
        ...
        self.assertEqual(result["numeric_computation"], "exact_rational_no_intermediate_rounding")
        self.assertEqual(result["rank_order_basis"], "unrounded_exact_combined_score_descending")
        self.assertEqual(result["tie_rule"], "equal_exact_combined_scores_share_competition_rank")
        self.assertEqual(result["source_export_sha256"], manifest["source_export_sha256"])
        self.assertTrue(result["profile_coverage_qa_required"])
