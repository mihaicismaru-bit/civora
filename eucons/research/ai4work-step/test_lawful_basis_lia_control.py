...
class LawfulBasisLiaControlTests(unittest.TestCase):
    ...
    def test_current_controller_approved_lia_is_structurally_safe_and_collection_stays_fail_closed(self):
        ...
        self.assertEqual(lia["controller_signoff_fields"]["privacy_contact"], "privacy@eucons.ro")
        self.assertEqual(lia["prod_approval"]["privacy_contact"], "privacy@eucons.ro")
    ...
    def test_any_prod_activation_claim_still_requires_live_lia_operational_bindings(self):
        ...
        self.assertNotIn("lia_privacy_contact_missing", errors)
        ...
        self.assertNotIn("lia_prod_privacy_contact_missing", errors)
