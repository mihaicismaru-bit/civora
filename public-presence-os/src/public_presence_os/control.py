...
def validate_repo(root: Path) -> ValidationResult:
    ...
    expected = [
        ...
        "config/meta_read_only_gate_policy.json",
        ...
        "tests/test_cp54_meta_transport_twin.py","tests/test_cp55_meta_read_only_gate.py",
        ...
        "docs/CP55_META_READ_ONLY_CONNECTION_GATE.md",
