...
def validate_repo(root: Path) -> ValidationResult:
    ...
    expected = [
        ...
        "config/analytics_policy.json","config/learning_policy.json","config/meta_adapter_policy.json",
        ...
        "src/public_presence_os/learning.py","src/public_presence_os/meta_adapters.py",
