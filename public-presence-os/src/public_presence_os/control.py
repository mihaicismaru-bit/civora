...
def validate_repo(root: Path) -> ValidationResult:
    ...
    expected = [
        ...
        "config/analytics_policy.json","config/learning_policy.json",
        ...
        "src/public_presence_os/learning.py",
        ...
        "tests/test_cp44_publisher.py","tests/test_cp45_analytics.py","tests/test_cp46_learning.py",
        ...
        "docs/CP44_PUBLISHER.md","docs/CP45_ANALYTICS.md","docs/CP46_LEARNING.md",
