...
def validate_repo(root: Path) -> ValidationResult:
    ...
    expected = [
        ...
        "config/qa_policy.json","config/approval_policy.json",
        ...
        "tests/test_cp40_visual.py","tests/test_cp41_qa.py","tests/test_cp42_approval.py",
        ...
        "docs/CP40_VISUAL_RENDERER.md","docs/CP41_VISUAL_QA.md","docs/CP42_APPROVAL_DASHBOARD.md",
