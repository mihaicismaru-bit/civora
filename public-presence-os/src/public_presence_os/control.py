...
def validate_repo(root: Path) -> ValidationResult:
    ...
    expected = [
        ...
        "src/public_presence_os/visual.py","src/public_presence_os/qa.py",
        ...
        "tests/test_cp40_visual.py","tests/test_cp41_qa.py",
        ...
        "docs/CP40_VISUAL_RENDERER.md","docs/CP41_VISUAL_QA.md",
