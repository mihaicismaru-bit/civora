...
def validate_repo(root: Path) -> ValidationResult:
    ...
    expected = [
        ...
        "config/control_plane_authorization_intake_policy.json",
        ...
        "tests/test_cp61_control_plane_authorization_intake.py",
        ...
        "docs/CP61_CONTROL_PLANE_AUTHORIZATION_INTAKE.md",
