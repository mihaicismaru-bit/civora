...
def validate_repo(root: Path) -> ValidationResult:
    ...
    expected = [
        ...
        "config/meta_preflight_policy.json",
        ...
        "src/public_presence_os/connection_preflight.py",
        ...
        "tests/test_cp51_connection_profiles.py","tests/test_cp52_connection_preflight.py",
