...
def validate_repo(root: Path) -> ValidationResult:
    ...
    expected = [
        ...
        "config/operator_profile.example.json","config/reimplementation_priority.json","config/image_rights_policy.json",
        ...
        "docs/CP34_RADAR_MINIMAL_EXECUTABLE_SLICE.md","docs/CP39_IMAGE_RIGHTS.md",
