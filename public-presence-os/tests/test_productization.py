...
def test_registry_unique_ids():
    ...
    assert any(m["id"]=="M25_META_LIVE_READ_ONLY_PROBE_RUNBOOK" and m["status"]=="CP56_LIVE_READ_ONLY_PROBE_RUNBOOK_CONTRACT_LOCAL_ONLY" for m in r["modules"])
...
def test_reimplementation_priority_closes_executable_source_backlog():
    ...
    assert states["M25_META_LIVE_READ_ONLY_PROBE_RUNBOOK"]=="CP56_LIVE_READ_ONLY_PROBE_RUNBOOK_CONTRACT_LOCAL_ONLY"
    assert p["next"]=="CP57_META_READ_ONLY_EVIDENCE_VALIDATOR_AND_SYNTHETIC_FIXTURE_PACK"
