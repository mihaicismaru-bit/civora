...
const REGISTRY={
  '2541894':{
    cui:'2541894',name:'Primăria Orașului Brezoi',legalName:'Orașul Brezoi',type:'municipality',entityClass:'UAT',county:'Vâlcea',region:'Sud-Vest Oltenia',locality:'Brezoi',address:'Str. Lotrului nr. 2, Brezoi, Vâlcea, 245500',phone:'0250778240',status:'ACTIVE',
...
function applyEntity(e){
  setValue('cwCui',e.cui);setValue('cwName',e.name||e.legalName);setValue('cwType',e.type);setValue('cwCounty',e.county);setValue('cwRegion',e.region);
