#!/usr/bin/env python3
"""Semantic reconciliation for exact EEA Civil Society Fund Romania Call #5 evidence."""
...
def reconcile(current: Mapping[str, Any], previous: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    if previous is None:
        ...
        state = "NO_CHANGE" if not changes else "EEA_CSF_CALL5_SEMANTIC_CHANGE_RECONCILED_NON_AUTHORIZING"
...
def validate_receipt(
    ...
    if previous is None:
        ...
        expected = (
            ...
            else "EEA_CSF_CALL5_SEMANTIC_CHANGE_RECONCILED_NON_AUTHORIZING"
        )
