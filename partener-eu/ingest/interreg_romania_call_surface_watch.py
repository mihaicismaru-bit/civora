...
SURFACES: tuple[dict[str, Any], ...] = (
    {
        ...
        "url": "https://jems-robg.mdlpa.ro/",
        "hosts": ("jems-robg.mdlpa.ro",),
        "anchors": ("Here you can find our latest calls", "Interreg VI-A Romania", "Jems"),
        "surface_role": "PROGRAMME_CALL_SUBMISSION_DISCOVERY",
        "observation_state": "CALL_DISCOVERY_ONLY",
        "programme_filter_required": False,
        "authority_note": "official Managing Authority JEMS surface for programme-specific latest-call discovery; exact call state must still be re-read on an exact official call endpoint",
        "fallback": {
    ...
    },
    {
        ...
        "url": "https://jems-romd.mdlpa.ro/",
        "hosts": ("jems-romd.mdlpa.ro",),
        "anchors": ("Here you can find our latest calls", "Interreg NEXT Romania", "Jems"),
        "surface_role": "PROGRAMME_CALL_SUBMISSION_DISCOVERY",
        "observation_state": "CALL_DISCOVERY_ONLY",
        "programme_filter_required": False,
        "authority_note": "official Managing Authority JEMS surface for programme-specific latest-call discovery; exact call state must still be re-read on an exact official call endpoint",
