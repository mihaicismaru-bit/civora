...
def main():
    ...
    for src in registry.get("sources", []):
        ...
        try:
            ...
            row.update({"ok": False, "health": "FAIL", "error": f"{type(exc).__name__}: {exc}", "semantic_hash_changed": False, "resolution_task_required": False, "publish_material_fact_update": False})
