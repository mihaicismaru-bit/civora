...
- TIKTOK: short-form local video publication; fast explainers, location-based updates, event/service hooks, recurring vertical formats and reporter-style scripts without synthetic portrayals of real people.
