...
KEEP_SCRIPT_EXACT = {
    ...
    "cfr_craiova_valcea_scope_validator.py",
    "discovery_snapshot_material.py",
    "editorial_quality_corpus_audit.py",
    "eta_valcea_service_news_temporal_gate.py",
    "gambing_dossier_enricher.py",
    "gambling_dossier_enricher.py",
    "gambling_dossier_enricher_v2.py",
    "health_workforce_detail_reconciliation.py",
    "infotrafic_valcea_breaking_candidates.py",
    "infotrafic_valcea_newsroom_review_envelope.py",
