        ...
        try:
            ...
            if isinstance(parsed, dict):
                keys = (
                    ...
                    "document_text_extracted_shadow_count","verified_document_count","verified_calendar_document_count","field_evidence_count","material_candidate_shadow_count",
